...
3) Code Explanation
	...
	-- Loading and Cleaning Data
		...
		* The load_movie_data() function loads the movie data from the movies.csv file into a pandas DataFrame:
	...
	-- GUI Setup
		...
		The Tkinter GUI allows users to interact with the application. The create_gui() function:

    			* Provides a dropdown menu for selecting the genre.
    			* Provides an input field for entering a minimum rating.
